        ...
        public (List<string>, List<string>) RunUpgradeEdits(ulong startVersion, ulong endVersion)
        {
            ...
            if (AssetLocator.Type == GameType.EldenRing)
            {
                ...
                paramUpgradeTasks = new (ulong, string, string)[]
                {
                    ...
                    (10701000l, "1.07 - (AssetEnvironmentGeometryParam) Set Reserve_4 to Vanilla v1.07 values", "param AssetEnvironmentGeometryParam: modified: Reserve_4: = vanillafield Reserve_4;"), (10801000l, "1.08 - (BuddyParam) Set Unk1 to default value", "param BuddyParam: modified: Unk1: = 1410;"),
                    (10801000l, "1.08 - (BuddyParam) Set Unk2 to default value", "param BuddyParam: modified: Unk2: = 1420;"), (10801000l, "1.08 - (BuddyParam) Set Unk11 to default value", "param BuddyParam: modified: Unk11: = 1400;"),
                };
            }
