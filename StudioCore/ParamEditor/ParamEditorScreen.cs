...
namespace StudioCore.ParamEditor
{
    ...
    public class ParamEditorScreen : EditorScreen
    {
        ...
        private string[] _autoFillArgsRop = Enumerable.Repeat("", MERowOperationStep.rowOps.AvailableCommands().Sum((x) => x.Item2.Length)).ToArray();
        private string[] _autoFillArgsCop = Enumerable.Repeat("", MEValueOperationStep.valueOps.AvailableCommands().Sum((x) => x.Item2.Length)).ToArray();
