...
public struct FastFlverImpl
{
    ...
    public void AProcessMesh(ref FlverSubmesh dest, ref FLVER0.Mesh mesh)
    {
    ...
    public unsafe void BProcessMesh(ref FlverSubmesh dest, ref FLVER0.Mesh mesh, ref int indicesTotal, ref bool is32bit, out Span<Vector3> pvhandle, out nint meshVertices, out nint meshIndices)
    {
        ...
        pvhandle = new(dest.PickingVertices.ToPointer(), mesh.Vertices.Count);
        ...
        meshVertices = dest.GeomBuffer.MapVBuffer();
        meshIndices = dest.GeomBuffer.MapIBuffer();
    }

    public unsafe void CProcessMesh(ref FlverSubmesh dest)
    {
        dest.GeomBuffer.UnmapVBuffer();
        dest.GeomBuffer.UnmapIBuffer();
    }

    public unsafe void DProcessMesh(ref FlverSubmesh dest, ref FLVER0.Mesh mesh)
    {
        ...
        //not calling Marshal.FreeHGlobal(dest.PickingVertices); ?
    }

    public unsafe void FillIndices(ref FLVER0.Mesh mesh, ref bool is32bit, ref nint meshIndices, ref int indicesTotal, ref int[] indices, ref FlverSubmesh dest)
    {
    ...
    private unsafe void ProcessMesh(FLVER0.Mesh mesh, FlverSubmesh dest)
    {
        ...
        AProcessMesh(ref dest, ref mesh);
        ...
        BProcessMesh(ref dest, ref mesh, ref indicesTotal, ref is32bit, out Span<Vector3> pvhandle, out nint meshVertices, out nint meshIndices);
        ...
        FillIndices(ref mesh, ref is32bit, ref meshIndices, ref indicesTotal, ref indices, ref dest);

        CProcessMesh(ref dest);
        DProcessMesh(ref dest, ref mesh);
    }

    public void AProcessMesh(ref FlverSubmesh dest, ref FLVER2.Mesh mesh)
    {
    }

    public unsafe void BProcessMesh(ref FlverSubmesh dest, ref FLVER2.Mesh mesh, ref int indicesTotal, ref bool is32bit, out Span<Vector3> pvhandle, out nint meshVertices, out nint meshIndices)
    {
        var vSize = dest.Material.VertexSize;
        dest.PickingVertices = Marshal.AllocHGlobal(mesh.VertexCount * sizeof(Vector3));
        pvhandle = new(dest.PickingVertices.ToPointer(), mesh.VertexCount);
    ...
    public unsafe void DProcessMesh(ref FlverSubmesh dest, ref FLVER2.Mesh mesh)
    {
        dest.Bounds = BoundingBox.CreateFromPoints((Vector3*)dest.PickingVertices.ToPointer(), dest.VertexCount, 12,
            Quaternion.Identity, Vector3.Zero, Vector3.One);
    ...
    public unsafe void FillIndices(ref FLVER2.Mesh mesh, ref bool is32bit, ref nint meshIndices, ref int indicesTotal, ref int[] indices, ref FlverSubmesh dest, ref List<FLVER2.FaceSet> facesets)
    {
        Span<ushort> fs16 = null;
        Span<int> fs32 = null;
        if (is32bit)
    ...
    public unsafe void BProcessMesh(ref FlverSubmesh dest, ref int vertexCount, ref int indicesTotal, ref bool is32bit, out Span<Vector3> pvhandle, out nint meshVertices, out nint meshIndices)
    {
        var vSize = dest.Material.VertexSize;
        var vbuffersize = (uint)vertexCount * vSize;
        dest.PickingVertices = Marshal.AllocHGlobal(vertexCount * sizeof(Vector3));
        pvhandle = new(dest.PickingVertices.ToPointer(), vertexCount);
    ...
    private unsafe void DProcessMesh(ref FlverSubmesh dest, ref FlverMesh mesh)
    {
        dest.Bounds = BoundingBox.CreateFromPoints((Vector3*)dest.PickingVertices.ToPointer(), dest.VertexCount, 12,
            Quaternion.Identity, Vector3.Zero, Vector3.One);
    ...
    private unsafe void FillIndicesParts(ref FlverFaceset faceset, ref int idxoffset, ref bool is32bit, ref BinaryReaderEx br, ref Span<int> fs32, ref Span<ushort> fs16, ref int vertexCount, ref FlverSubmesh dest)
    {
        //At this point they use 32-bit faceset vertex indices
        FlverSubmesh.FlverSubmeshFaceSet newFaceSet = new()
        {
        ...
        Span<FlverFaceset> facesets, FlverSubmesh dest)
    {
        ...
        BProcessMesh(ref dest, ref vertexCount, ref indicesTotal, ref is32bit, out Span<Vector3> pvhandle, out nint meshVertices, out nint meshIndices);
        ...
        foreach (var fsidx in facesetIndices)
        {
            ...
            FillIndicesParts(ref faceset, ref idxoffset, ref is32bit, ref br, ref fs32, ref fs16, ref vertexCount, ref dest);
